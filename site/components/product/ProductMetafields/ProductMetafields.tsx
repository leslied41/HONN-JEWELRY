...
const ProductMetafelds = (props: Props) => {
  return (
    <div>
      ...
      <Carat className="mt-6 w-full sm:w-[265px]" />
      <SquareGroupOption
        variant={Variant.A}
        className="mt-6 w-full sm:max-w-[231px]"
      />
      <SquareGroupOption
        variant={Variant.B}
        className="mt-6 w-full sm:max-w-[231px]"
      ...
      <SquareGroupOption
        ...
        className="mt-6 w-full sm:max-w-[231px]"
      />
      <DropdownOption variant="B" className="mt-6 w-full sm:w-[265px]" />
      <InputOption className="mt-6 w-full sm:w-[265px]" />
